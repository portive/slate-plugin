...
/**
 * Returns true if the Blob (File) is an animated GIF
 *
 * Code generated by Chat GPT
 */
function isAnimatedGif(blob: Blob): Promise<boolean> {
  ...
  return new Promise((resolve) => {
    reader.onload = () => {
      ...
      const header = String.fromCharCode.apply(
        null,
        arr.subarray(0, 6) as unknown as number[]
      )
      resolve(header === "GIF89a" || header === "GIF87a")
    }
  })
}
